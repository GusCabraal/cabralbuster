    ...
    await queryInterface.bulkInsert('users', [
      {
        ...
        admin: true,
        image: `${process.env.DOMAIN}/images/usersProfile/cabral_profile.jpeg`
      },
      {
        id: 2,
        ...
        admin: false,
        image: `${process.env.DOMAIN}/images/usersProfile/rocky_profile.jpg`,
      },
      {
        id: 3,
        username: 'Django',
        ...
        admin: false,
        image: `${process.env.DOMAIN}/images/usersProfile/django_profile.jpg`,
      },
    ]);
  },
